...
class KnowledgeBaseManager extends BaseEl {
  ...
  toggleCsvManager() {
    this.showCsvManager = !this.showCsvManager;
  }
          ...
          ${this.selectedKb ? html`
            ...
            <div class="url-form">
              ...
              <div class="tab-buttons">
                <div class="tab-button ${!this.showCsvManager ? 'active' : ''}" 
                     @click=${() => this.showCsvManager = false}>Standard Files & URLs</div>
                <div class="tab-button ${this.showCsvManager ? 'active' : ''}" 
                     @click=${() => this.showCsvManager = true}>CSV Database</div>
              </div>

              ${!this.showCsvManager ? html`
